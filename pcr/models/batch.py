...
class Sample(models.Model):
  ...
  lab_id_num = models.CharField(blank=False, max_length=25) # lab id with number - auto generated by combining lab_id from Batch and adding a number to it
  sample_id = models.CharField(blank=True, max_length=100) # actual id of sample - manually generated by user by turning csv into html or copy/paste (JS)
