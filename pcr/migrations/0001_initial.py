    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('storage_location', models.ManyToManyField(to='pcr.location')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catalog_number', models.CharField(max_length=25)),
                ('number', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('number_per_sample', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('storage_location', models.ManyToManyField(to='pcr.location')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catalog_number', models.CharField(max_length=25)),
                ('volume', models.DecimalField(decimal_places=2, max_digits=12, validators=[django.core.validators.MinValueValidator(0)])),
                ('volume_per_sample', models.DecimalField(decimal_places=2, max_digits=12, validators=[django.core.validators.MinValueValidator(0)])),
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('storage_location', models.ManyToManyField(to='pcr.location')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solutions', models.ManyToManyField(to='pcr.solution')),
                ('tubes', models.ManyToManyField(to='pcr.tube')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            model_name='solution',
            constraint=models.UniqueConstraint(fields=('user', 'lot_number', 'catalog_number'), name='solution_unique', violation_error_message='Solutions with the same lot and catalog number already exists.'),
        ),
        migrations.AddConstraint(
            model_name='sample',
