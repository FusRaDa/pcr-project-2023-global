    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pcr.sample')),
            ],
        ),
        migrations.CreateModel(
            name='ProcessPlate',
        ...
        migrations.AddField(
            model_name='process',
            name='samples',
            field=models.ManyToManyField(through='pcr.ProcessSample', to='pcr.sample'),
        ),
        migrations.AddField(
            model_name='process',
            name='user',
