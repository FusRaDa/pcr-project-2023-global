    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volume', models.DecimalField(decimal_places=3, max_digits=12, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gel', models.ManyToManyField(to='pcr.gel')),
                ('pcr_dna_protocol', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pcr_dna', to='pcr.thermalcyclerprotocol')),
                ('pcr_rna_protocol', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pcr_rna', to='pcr.thermalcyclerprotocol')),
                ('plate', models.ManyToManyField(to='pcr.plate')),
                ('qpcr_dna_protocol', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='qpcr_dna', to='pcr.thermalcyclerprotocol')),
                ('qpcr_rna_protocol', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='qpcr_rna', to='pcr.thermalcyclerprotocol')),
        ...
        migrations.AddField(
            model_name='assay',
            name='controls',
            field=models.ManyToManyField(through='pcr.ControlAssay', to='pcr.control'),
        ),
        migrations.AddField(
            model_name='assay',
            name='fluorescence',
